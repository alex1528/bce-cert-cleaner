...
```bash
git clone https://github.com/YOUR_USERNAME/bce-cert-cleaner.git
cd bce-cert-cleaner
go mod tidy
...
证书ID             证书名称                       使用中   过期时间
--------------------------------------------------------------------------------
cert-xj4k6gp9hzwn  yiming68_com                   否       2025-04-30 (剩余69天)
cert-a9w6v40dsmjh  magicrepokit_com               否       2025-05-06 (剩余75天)
cert-d5bsxfvpawgr  example_cn                     否       2025-05-07 (剩余76天)
cert-pxhmmb2n6azs  expired_example_com            否       2024-01-15 (已过期45天)
...
================================================================================
统计: 总计 23 个证书
  - 使用中: 0 个
...
[1] 证书ID: cert-pxhmmb2n6azs
    ...
    通用名称: *.example.com
    过期时间: 2024-01-15 00:00:00 (已过期 45 天)
--------------------------------------------------------------------------------
[2] 证书ID: cert-abc123xyz
    证书名称: old_domain_cert
    通用名称: old.domain.com
    过期时间: 2024-02-01 00:00:00 (已过期 28 天)
--------------------------------------------------------------------------------
...
[3] 证书ID: cert-def456uvw
    ...
    过期时间: 2024-01-20 00:00:00 (已过期 40 天)
--------------------------------------------------------------------------------
...
```text
2024/02/20 03:00:01 [INFO] 开始清理 2 个未使用且已过期的证书
2024/02/20 03:00:02 [INFO] 删除证书成功: expired_example_com (cert-pxhmmb2n6azs)
2024/02/20 03:00:02 [INFO] 删除证书成功: old_domain_cert (cert-abc123xyz)
2024/02/20 03:00:02 [INFO] 清理完成: 成功 2 个, 失败 0 个
```
